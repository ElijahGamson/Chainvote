...
// Uses hardcoded data for now, blockchain reads replace this later

import ProposalCard from "../components/ProposalCard";
import dummyProposals from "../dummyData";

// Pretend this wallet voted For on #1 and Against on #3
const myVotes = [
...
export default function MyVotes() {
  // Match vote records to their full proposal data
  const votedItems = myVotes.map((v) => ({
